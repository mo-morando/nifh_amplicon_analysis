...
pie_chart_AUID_depud_DNA_counts <- ggplot(nifhdb_all_counts_AUID_dedup_clean, aes(
  ...
  scale_fill_manual(values = nifh_cluster_colours) +
  theme(
...
(nifhdb_all_counts_AUID_dedup_study_id_total_bar_plot <- bar_plot(
  ...
  # fill = nifH_cluster_modified,
  fill = cluster_stats,
  fill_pallete = nifh_cluster_colours,
...
### * save plot
ggsave("/Users/mo/Projects/nifH_amp_project/myWork/analysis/plots/bar_chart_nifhDB_DNA_dedup_perc_tot_nifH_cluster_studyID_cmb_plot.jpeg", height = 12.5, width = 21, units = "in", dpi = 300)
